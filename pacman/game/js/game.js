...
function initGame(newGame) {
	...
	// player knows how far behind they might be
	// when compared to the best player.
	...
	// Load the user score and level from the backend
	// to present in the UI and then reconstruct their
	// headline for a better user experience.
	loadLastData(function(lastData) {
		doInitGame(newGame, lastData);
	});
	
}

function doInitGame(newGame, lastData) {
...
function lifes(l) { 
	...
	// Emit event user game event
	writeEvent(newEventData(0));
